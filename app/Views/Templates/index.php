...
<head>
    ...
    <!-- Favicon -->
    <!-- <link rel="shortcut icon" href="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/favicon.ico" /> -->

    <link rel="shortcut icon" href="<?= base_url('Assets/img/LOGO SMANSA.png'); ?>" type="image/x-icon" />
    ...
    <!-- Aos Animation Css -->
    <link rel="stylesheet" href="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/vendor/aos/dist/aos.css" />
...
<body class="">
    ...
    <!-- sidebar -->
    <?= $this->include('patrials/sidebar'); ?>
    <!-- sidebar -->
    <main class="main-content">
        <div class="position-relative iq-banner">
            <!--Nav Start-->
            <?= $this->include('patrials/header'); ?>
            ...
            <div class="iq-navbar-header" style="height: 215px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    <h1>Hallo, <?= session()->get('nama_user'); ?> !</h1>
                                    <p>
                                        Selamat Datang di Aplikasi SIMAS
                                    </p>
                                </div>
                                <div>
                ...
                <div class="iq-header-img">
                    <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/dashboard/top-header.png"
                        alt="header" class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/dashboard/top-header1.png"
                        alt="header" class="theme-color-purple-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/dashboard/top-header2.png"
                        alt="header" class="theme-color-blue-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/dashboard/top-header3.png"
                        alt="header" class="theme-color-green-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/dashboard/top-header4.png"
                        alt="header" class="theme-color-yellow-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/dashboard/top-header5.png"
                        alt="header" class="theme-color-pink-img img-fluid w-100 h-100 animated-scaleX">
                </div>
        ...
        <footer class="footer">
            <div class="footer-body">
                ...
                <div class="right-panel">
                    ...
                    </script> SIMAS - All Rights Reserved
                    <span class="">
                    ...
                    </span> by <a href="#"> TIM IT SMANSA</a>
                </div>
            </div>
        </footer>
        <!-- Footer Section End -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/01.png"
                                alt="ltr" class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="dir-mode" data-name="dir" data-value="ltr">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/01.png"
                                alt="ltr" class="mode light-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="dir-mode" data-name="dir" data-value="ltr">
                            <span class=" mt-2"> LTR </span>
                        </div>
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/02.png"
                                alt="" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="dir-mode" data-name="dir" data-value="rtl">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/02.png"
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/03.png"
                                alt="mini" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/03.png"
                                alt="mini" class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                            <span class="mt-2">Mini</span>
                        </div>
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/04.png"
                                alt="hover" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover"
                                data-extra-value="sidebar-mini">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/04.png"
                        ...
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/05.png"
                                alt="boxed" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-boxed">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/05.png"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/06.png"
                            ...
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/06.png"
                                alt="rounded-one-side" class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                            <span class="mt-2">Rounded One Side</span>
                        </div>
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/07.png"
                                alt="rounded-all" class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/07.png"
                                alt="rounded-all"
                        ...
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/08.png"
                                alt="pill-one-side" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/09.png"
                                alt="pill-one-side" class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                            <span class="mt-2">Pill One Side</span>
                        </div>
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/09.png"
                                alt="pill-all" class="mode dark-img img-fluid btn-border p-0 flex-column"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill-all">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/08.png"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 ">
                        <div class=" text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/11.png"
                                alt="image" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="nav-glass">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/10.png"
                        ...
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/10.png"
                                alt="color" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar-header" data-name="navbar-type"
                                data-value="navs-bg-color">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/11.png"
                        ...
                        <div class=" text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/12.png"
                                alt="sticky" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-sticky">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/12.png"
                        ...
                        <div class="text-center">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/dark/13.png"
                                alt="transparent" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-transparent">
                            <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/settings/light/13.png"
                                alt="transparent" class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-transparent">
    ...
    <script src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/vendor/aos/dist/aos.js"></script>
