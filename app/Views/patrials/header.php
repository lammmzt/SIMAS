            ...
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <div class="p-0 card-body">
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                            src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>/assets/images/shapes/01.png"
                                            alt="">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <div class="">
                                            <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>/assets/images/shapes/02.png"
                                                alt="">
                                        </div>
                                        <div class="ms-3 w-100">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                            src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>/assets/images/shapes/03.png"
                                            alt="">
                                        <div class="ms-3 w-100">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                            src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>/assets/images/shapes/04.png"
                                            alt="">
                            ...
                            <div class="p-0 card-body ">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <div class="">
                                            <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>/assets/images/shapes/05.png"
                                                alt="">
                                        </div>
                                        <div class="ms-3">
                ...
                <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button"
                        ...
                        <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>/assets/images/avatars/01.png"
                            alt="User-Profile"
                            class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
                        <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>/assets/images/avatars/avtar_1.png"
                            alt="User-Profile" class="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded">
                        <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>/assets/images/avatars/avtar_2.png"
                            alt="User-Profile" class="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded">
                        <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>/assets/images/avatars/avtar_4.png"
                            alt="User-Profile" class="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded">
                        <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>/assets/images/avatars/avtar_5.png"
                            alt="User-Profile" class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded">
