...
<body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    ...
    <div class="wrapper">
        ...
        <div class="gradient">
            <div class="container">
                <img src="<?= base_url('Assets/hope-ui-html-2.0/html/'); ?>assets/images/error/404.png"
                    class="img-fluid mb-4 w-50" alt="">
                <h2 class="mb-0 mt-4 text-white">Maff! SKL Belum Tersedia Untuk Saat Ini.</h2>
                <p class="mt-2 text-white">
                    Silahkan Tunggu Informasi Selanjutnya.
                </p>
                <button type="button" onclick="window.close()"
                    class="btn bg-white text-primary d-inline-flex align-items-center" id="back_paage">Kembali Ke
                    Halaman
                    Sebelumnya</button>
            </div>
            <div class="box">
