...
class RaporCoppy extends BaseController
{  
    ...
    public function cetakSemuaTranskrip()
    {
        ...
        if ($data_siswa) { // jika data siswa ada
            ...
            $data['urutan_mapel_lokal'] = $urutanMapelLokal;
            // dd($data);
            // return view('Admin/Rapor/cetak/cetak_transkrip', $data);
            $html = view('Admin/Rapor/cetak/cetak_all_transkrip', $data);
            $mpdf->WriteHTML($html);
    ...
    public function generateTranskrip()
    {
        ...
        foreach ($data_nilai_group as $dtn) {
            ...
            $data['urutan_mapel_lokal'] = $urutanMapelLokal;
            $data['imageSrc'] = $imageSrc;
            $html = view('Admin/Rapor/cetak/cetak_transkrip', $data);
